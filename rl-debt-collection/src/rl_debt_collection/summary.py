...
def calculate_revenue(
    ...
    """
    Returns the revenue between start_period and end_period, inclusively. If start_period or end_period is None, it will use the earliest/latest available data.
    """
...
def calculate_cost(
    ...
    """
    Returns the cost between start_period and end_period, inclusively. If start_period or end_period is None, it will use the earliest/latest available data.
    """
